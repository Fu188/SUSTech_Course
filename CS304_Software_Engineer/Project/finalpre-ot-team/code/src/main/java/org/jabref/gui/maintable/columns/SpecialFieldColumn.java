...
public class SpecialFieldColumn extends MainTableColumn<Optional<SpecialFieldValueViewModel>> {
    ...
    // CS304 Issue link: https://github.com/JabRef/jabref/issues/7015
    /**
     * constructs an special field column
     *
     * @param model Model of main table column
     * @param preferencesService A service containing preferences information
     * @param undoManager Manager used to undo action
     */
