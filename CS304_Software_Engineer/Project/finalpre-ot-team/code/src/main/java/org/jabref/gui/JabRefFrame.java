...
public class JabRefFrame extends BorderPane {
    ...
    // CS304 Issue link: https://github.com/JabRef/jabref/issues/6994
    /**
     * creates a navigator menu and sets all the inside elements
     * @return A menuBar on the top of the UI
     */
