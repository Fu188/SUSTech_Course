...
class BracketedPatternTest {
    ...
    // CS304 Issue link: https://github.com/JabRef/jabref/issues/7111
    /**
     * tests whether the entry of bracketed pattern will be expanded correctly with fallback
     * @param expandResult the expected result the entry is expanded to
     * @param pattern      the given pattern of entry
     */
    @ParameterizedTest
    ...
    // CS304 Issue link: https://github.com/JabRef/jabref/issues/7111
    /**
     * provides test data stream for expandBracketsWithFallback()
     * @return A test data stream where each is composed of an expand result and a bracketed pattern
     */
