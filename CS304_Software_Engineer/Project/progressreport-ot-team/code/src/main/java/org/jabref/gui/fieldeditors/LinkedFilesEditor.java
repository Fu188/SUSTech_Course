...
public class LinkedFilesEditor extends HBox implements FieldEditorFX {
    ...
    // CS304 Issue link: https://github.com/JabRef/jabref/issues/7382
    /**
     * sets the content and style of "file field" according to the linked file.
     * @param linkedFile contains all the info about the linked file
     * @return A HBox container which contains the info of linked file and buttons
     */
